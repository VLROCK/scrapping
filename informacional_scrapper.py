...
class WaybackScraperPipeline:
    ...
    async def get_cdx_snapshots_trimestre(
        ...
        params = {
            ...
            "collapse": "urlkey",
            "limit":  "50",  # 8 × 4 trimestres × 12 anos = 384 por domínio
        }
...
if __name__ == "__main__":
    dominios = [
        ...
        # --- Tutoriais e Tecnologia (Dicas/Passo a Passo) ---
        "techtudo.com.br",
        "tecmundo.com.br",
        "canaltech.com.br",
        
        # --- Informacional/Variedades (Como fazer, dicas de casa, saúde) ---
        "mdsaude.com",
        "tuasaude.com",
